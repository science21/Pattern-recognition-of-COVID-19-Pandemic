...
npdata=orgdata.iloc[:,50:].values #get data from March 1th

m,n=npdata.shape

npdailycase=np.zeros(npdata.shape) # get daily new case data
...
#plt.scatter(X[y_kmeans == 3, 0], X[y_kmeans == 3, 1], s = 20, c = 'red', label = 'Cluster 4')
...
Index(['Alabama', 'Alaska', 'Arizona', 'Arkansas', 'California', 'Colorado',
       ...
       'West Virginia', 'Wisconsin', 'Wyoming', 'US', 'Res_US'],
...
top5=Tstatedaily.loc[:,['California', 'Texas', 'Florida','Illinois', 'New York']]
top10 = Tstatedaily.loc[:,['Ohio', 'Georgia', 'Pennsylvania','Tennessee', 'Michigan']]                 
                     
top15=Tstatedaily.loc[:,['North Carolina','Indiana', 'Wisconsin', 'Arizona', 'New Jersey']]
top20=Tstatedaily.loc[:,['Minnesota', 'Missouri','Alabama','Massachusetts','Virginia']]
...
ax1.plot(x, top5)
ax1.legend(loc=2, ncol=5, labels= ['California', 'Texas', 'Florida','Illinois', 'New York'])

ax2.plot(x, top10)
ax2.legend(loc=2, ncol=5, labels= ['Ohio', 'Georgia', 'Pennsylvania','Tennessee', 'Michigan'])

ax3.plot(x, top15)
ax3.legend(loc=2, ncol=5, labels= ['North Carolina','Indiana', 'Wisconsin', 'Arizona', 'New Jersey'])
